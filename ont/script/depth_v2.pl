...
my $bam=shift;
my $outdir=shift;
my $samApp = "/mnt/CCX/Share/software/Anaconda3/envs/SV-workflow/bin/samtools";
my $RApp = "/mnt/CCX/Share/software/Anaconda3/envs/SV-workflow/bin/R";
...
print SUM "$total_Coverage_bases\t$total_aa\t$Coverage_bases\t$Coverage_bases_4\t$total_chr\n";
